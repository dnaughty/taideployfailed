...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { dcity: @district.dcity, dcountry: @district.dcountry, dcounty: @district.dcounty, dname: @district.dname, dstate: @district.dstate } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { dcity: @district.dcity, dcountry: @district.dcountry, dcounty: @district.dcounty, dname: @district.dname, dstate: @district.dstate } }
